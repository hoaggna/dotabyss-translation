...
translations["hmr_10220100011"] = {
    "激しい雨音が洞窟の外で轟いている。<br>一歩先も見えない濃霧と、体温を奪い去る冷たい雨。": "Tiếng mưa dữ dội ầm ầm ngoài hang động.<br>Màn sương mù dày đặc che khuất tầm nhìn và cơn mưa buốt giá.",
...
# ==============================================================================
# HMR_10220100021 (Yuri 2 Intro - Brothel)
# ==============================================================================
translations["hmr_10220100021"] = {
    ...
    "ユーリは、あろうことか自ら娼館の門を叩く。すべては最愛の人に<br>最高のもてなしを提供するための、彼女なりの”聖務”としての決断だった。": "Yuri đã tự mình gõ cửa kỹ viện. Tất cả là vì muốn dâng hiến<br>những điều tuyệt vời nhất cho người mình yêu như một 'thánh vụ'.",
    ...
    "……はぁ。実は今度、山の頂に出没するモンスターの調査隊に<br>抜擢されちゃってね。正直、登山の経験なんてあんまりないから不安なんだ。": "Haizz. Thật ra đợt này tôi được chọn vào đội khảo sát quái vật<br>trên đỉnh núi. Nói thật là ít kinh nghiệm leo núi nên lo quá.",
    "登山についてなら、わたしは詳しいですよ。なにせ、山生まれの山育ちですし、<br>それにミレスガルド騎士団の山岳訓練にだって同行してますからねっ。": "Về leo núi thì em rành lắm đó. Dù sao em sinh ra và lớn lên ở núi rừng,<br>lại còn từng đi theo huấn luyện vùng núi của kỵ sĩ đoàn Milesgard nữa.",
    "それは心強いな……。かなりの標高まで登るらしくて、テントや寝袋、<br>それに食糧……相当な重量の荷物を運ぶことになるらしいんだ。": "Nghe yên tâm hẳn... Nghe đâu phải leo lên độ cao lớn, lều bạt, túi ngủ,<br>lại thêm lương thực... vác hành lý nặng lắm.",
    "うーん、荷物は詰めかたや背負いかたで、疲労がまったく違いますからね。<br>お客さんの仰る装備なら、大体わたしと同じくらいの重さになりそうですね。": "Ừm, cách sắp xếp và đeo hành lý ảnh hưởng rất nhiều đến thể lực.<br>Số trang bị anh nói chắc nặng cỡ bằng người em đó ạ.",
    ...
    "フフ、いいですよ。ですが……抱え上げるだけなら簡単です。実際の山道では、<br>その重さを支えて歩き続ける強靭な足腰が必要になりますから……": "Hi hi, được chứ ạ. Nhưng chỉ bế lên thì dễ lắm. Đường núi thực tế<br>đòi hỏi đôi chân và vùng hông cực kỳ dẻo dai để đi liên tục...",
    ...
    "……そうだ。それなら、わたしを使って足腰の鍛錬、してみます？": "...Đúng rồi. Hay là anh dùng em để luyện tập thể lực hông và chân nhé?",
...
translations["hmr_10220100022"] = {
    "（な、なんですか、この格好……っ！？　アソコが丸見えだし……<br>それに、お客さんの熱いのが、あんなに近くに……っ！）": "(T-Tư thế gì thế này...!? Chỗ đó bị nhìn thấy hết trơn...<br>Lại còn thứ nóng rực của khách đang ở sát sạt thế này...!)",
    "正面に据えられた大きな鏡には、男の腕に太ももを掴まれ、<br>無防備に股を開かされた自分の姿が、隅々まで鮮明に映し出されている。": "Chiếc gương lớn trước mặt phản chiếu rõ từng chi tiết thân thể cô,<br>đang bị người đàn ông giữ chặt đùi và banh rộng hai chân ra.",
    ...
    "あまりの羞恥心に体勢を変えることを提案しようとするが、<br>男は鼻息荒く、そのまま行為をしたいと提案してくる。": "Vì quá ngượng ngùng nên cô định đổi tư thế,<br>nhưng người đàn ông thở dồn dập, muốn cứ thế mà tiếp tục làm tới.",
    "え？　え？<br>こ、このまま……しちゃうんですかっ！？": "Eh? Eh?<br>C-Cứ để thế này... mà làm luôn sao ạ!?",
    "はぁぁっ……！　あっ……やっ……ちょ、ちょっと……！": "Haaa...! A... đừng mà... ch-chờ chút...!",
    "止める間もなく、男は腰を動かしてユーリの膣口に陰茎をこすりつけ始める。<br>敏感な部位を擦られ、ユーリは漏れそうになる声を咄嗟に飲み込む。": "Không kịp ngăn lại, gã đàn ông đưa hông chà xát dương vật lên cửa mình Yuri.<br>Bị cọ xát nơi nhạy cảm, Yuri vội nuốt ngược tiếng rên vào trong.",
    ...
    "男の腰の動きが大きくなり、長いストロークでユーリの敏感な部位を<br>擦り上げていく。日頃鍛錬に励んでいるのだろう。体力が尽きる様子はない。": "Nhịp hông của gã đàn ông mạnh dần, miết dài qua vùng nhạy cảm của Yuri.<br>Chắc nhờ hay rèn luyện nên gã chẳng có vẻ gì là đuối sức.",
    "あっ、はぁぁっ～……ゃんっ！<br>あ、あのっ……も、もうちょっと、落ちついて……": "A, haaa... a nhược!<br>A-Anh ơi... b-bình tĩnh lại chút đã...",
    "激化する摩擦に、ユーリは自制を食い破られ声を漏らす。<br>翻弄され揺れる身体から溢れる甘い悲鳴が、男の欲情を激しく煽っていく。": "Ma sát ngày càng mãnh liệt khiến Yuri không kìm được tiếng rên.<br>Những tiếng kêu ngọt ngào rung rẩy càng thổi bùng dục vọng của người đàn ông.",
    "あっ、はぁぁ……っ、んっ、ひぅぅっ……ふあっ、あっ、はぁぁ……っ！": "A, haaa... ưm, hức... a, haaa...!",
    "小ぶりな乳房が、激しく揺さぶられる度に震え、鏡の中で淫らに波打つ。<br>その淫靡な姿に、男の陰茎は天を突くように角度を上げ――": "Cặp tuyết lê nhỏ nhắn nảy lên theo từng đợt va chạm, dập dềnh trong gương.<br>Hình ảnh dâm mỹ đó khiến dương vật gã đàn ông ngóc cao hơn nữa――",
    ...
    "ふぅ……ふぅぅ……どうぞ、このまま続けてください。<br>……これは、険しい山道を登るための鍛練ですから。": "Phù... phù... Xin anh cứ tiếp tục thế này đi ạ.<br>...Dù sao đây cũng là bài luyện tập để vượt qua đường núi hiểm trở mà.",
    "ユーリの優しい言葉に、客の男は安心する。<br>肉棒に伝わる柔らかな誘惑に、欲情が湧き上がって来る。": "Lời nói dịu dàng của Yuri làm gã yên tâm.<br>Sự mềm mại ôm siết lấy thanh thịt khiến cơn dục vọng lại bùng cháy.",
    "あっ、はぁあっ、あっ、やぅっ……！　んっ、あっ、あぁっ……！": "A, haaa, a, đừng mà...! Ưm, a, aaaa...!",
    "突き上げられる衝撃にユーリは身を震わせる。亀頭が子宮口を直接叩くたび、<br>彼女の口からは本能的な喘ぎが漏れ出す。": "Yuri run rẩy trước những cú thúc mạnh mẽ. Mỗi lần quy đầu nện vào tử cung,<br>tiếng thở dốc bản năng lại bật ra khỏi bờ môi cô.",
    "鏡に映る、快楽に頬を染め、視線を泳がせる自分の姿。<br>そのあまりの淫らさに、彼女の頭の中にある疑念が湧き上がる。": "Nhìn bóng mình trong gương với đôi má ửng hồng vì khoái lạc,<br>sự dâm đãng ấy khiến trong đầu cô nảy sinh một mối hoài nghi.",
    "（あぁ……わたしって、感じてる時こんな淫らな顔してるんだ……。<br>……わたし、本当はエッチが大好きな淫らな女の子なのかな……？）": "(A... hóa ra khi sướng mình lại có nét mặt dâm đãng thế này...<br>...Phải chăng mình thực sự là đứa con gái nghiện làm chuyện ấy...?)",
    "疑念とは裏腹に、子宮の奥からは溢れんばかりの愛液が湧き出す。<br>己の身体の正直な反応に、ユーリはついに自制心を投げ出してしまう。": "Trái với suy nghĩ ấy, dâm dịch từ sâu trong tử cung cứ trào ra như suối.<br>Trước phản ứng thành thật của cơ thể, Yuri đành buông bỏ mọi sự kiềm chế.",
    "も、もっと……もっと、激しくしてください……！": "X-Xin anh... hãy làm mạnh hơn nữa đi ạ...!",
    "いっっ！？　あっっ、はぁっ、やぁっ……あっ、んぅ、ひあぁ……！": "A...!? A, haaa, đừng mà... a, ưm, aaa...!",
    "自分の口から出た思いがけない言葉にハッとする間もなく、<br>男の腰の動きが大きくなり、肉棒による刺激は激しさを増す。": "Chưa kịp ngỡ ngàng trước lời thốt ra từ chính miệng mình,<br>nhịp thúc của người đàn ông đã dồn dập, kích thích dữ dội hơn.",
    "はぁぁんっ……！　あぁぁっ……ぅうんっ……はぁぁっ！<br>す、凄い……これっ！": "Haaa...! Aaa... ưm... haaa!<br>T-Tuyệt quá... cái này...!",
    "ユーリの求めを受け、男は欲望のままに肉棒を突き上げる。<br>より硬く、より太くなった肉棒に膣を刺激され、ユーリを更なる快楽が襲う。": "Được Yuri yêu cầu, gã đàn ông thúc mạnh thanh thịt theo bản năng.<br>Thanh thịt ngày càng cương to chà xát thành âm đạo, đẩy Yuri vào cơn mê muội.",
    "（お客さんのアレ、わたしの一番気持ちいいところに当たってる……！<br>このままじゃあ……このままじゃあ……！）": "(Thứ của khách... đang đâm trúng chỗ sướng nhất của mình...!\nCứ thế này thì... cứ thế này thì...!)",
    "あぁあっ！　あっ、はんっ！　い、いいですぅ……！<br>気持ち、良すぎてぇ……あ、頭、真っ白になりますぅ……！": "Aaa! A, haaa! T-Tuyệt quá...!\nSướng... sướng quá rồi... đầu óc em trắng xóa hết cả rồi...!",
    ...
    "ユーリの膣がビクビクと収縮する。<br>その蠕動が男の射精感をも高まらせ、最後のスパートがかかる。": "Âm đạo của Yuri co thắt giật giật từng cơn.<br>Sự mút chặt ấy kích thích khoái cảm xuất tinh của gã đàn ông lên tột cùng.",
    "イク……っ、イっちゃいますぅ～！<br>イク、イクイクっ、イっちゃうぅぅぅ～～……！": "Ra... em ra đâyyy!\nRa, em lên đỉnh đâyyy...!",
    "はぁあぁぁぁっ……！　ぁはぁぁ～～～～ッ！": "Haaaaaa...! Aaaaaa...!",
    "ユーリの顎が跳ね上がり、激しい痙攣と共に絶頂が訪れる。<br>その瞬間、大量の白濁液がユーリの膣内へと勢いよく流し込まれていく。": "Yuri ngửa cổ ra sau, đón nhận cơn cực khoái cùng những đợt co giật kịch liệt.<br>Đúng lúc đó, dòng tinh dịch trắng đục bắn xối xả vào trong âm đạo cô.",
    "はぁあぁ……んっ、ふぁっ……。<br>お腹の中……まだ、いっぱい出てます……すごい……": "Haaa... ưm, phù...<br>Bên trong bụng em... vẫn đang bắn ra nhiều quá... tuyệt thật...",
    "膣内を熱い精液で満たされていく快感。<br>それと同時にユーリは客との”訓練”が無事終了したことに安堵する。": "Cảm giác âm đạo ngập tràn tinh dịch nóng hổi thật sung sướng.<br>Đồng thời Yuri cũng thở phào vì buổi 'luyện tập' với khách đã xong xuôi.",
    "はぁぁ～……お腹の中……あったかい……": "Haaa~... bên trong bụng... ấm áp quá...",
    "注ぎ込まれる精液の熱にうっとりと目を細めるユーリ。<br>しかし、これで訓練が終わると思っていた彼女の予想は、無情にも裏切られる。": "Yuri say đắm híp mắt tận hưởng hơi ấm của dòng tinh dịch.<br>Thế nhưng, mong muốn buổi tập kết thúc của cô đã bị dập tắt phũ phàng.",
    "えっ！？　ちょっ……ちょっと待ってください！！": "Eh!? Khoan... khoan đã anh ơi!!",
    "収まるどころか、再び硬度を増した肉棒が、<br>絶頂の余韻に震える彼女の膣内を再び蹂躙し始めたのだ。": "Chẳng những không xìu xuống, thanh thịt lại cương cứng trở lại,<br>tiếp tục giày xéo bên trong âm đạo vẫn còn đang run rẩy sau cơn lên đỉnh.",
    "あっ、まっ、待ってぇ……！<br>こ、こんなの……わたしの身体がもたないってばぁっ！　ひうっ！？": "A, ch-chờ chút đã...!<br>Thế này... cơ thể em không chịu nổi đâu mà! Hya!?",
    "涙目でユーリが主張するも、火がついた男を止めることはできず――<br>娼館の一室に、再び嬌声が響き渡るのだった。": "Dù Yuri rơm rớm nước mắt phản đối nhưng chẳng thể cản nổi gã đàn ông đang hăng máu――<br>Trong gian phòng kỹ viện, tiếng rên kiều mị lại tiếp tục vang vọng."
}
...
translations["hmr_10220100023"] = {
    ...
    "それに、わたしを抱えてあんなに何度もできるのですものね。<br>きっと、足腰の筋力も、体力も申し分ないと思いますよ。": "Với lại anh bế em làm được nhiều hiệp như thế,<br>thì thể lực và sức bền đôi chân của anh chắc chắn thừa sức leo núi rồi.",
    "とはいえ、山では色んな危険が予想外に襲ってくるものです。<br>決して無理はせず、細心の注意を払って進んでくださいね。": "Tuy vậy trên núi luôn rình rập những nguy hiểm bất ngờ.<br>Anh tuyệt đối đừng gắng gượng quá sức và hãy thật cẩn thận nhé.",
    ...
    "エッチしてる時のわたしって、あんな顔してるんだ……。<br>しれーとしてる時も、あんな感じなのかな……？": "Hóa ra lúc làm chuyện ấy mặt mình lại như thế...<br>Lúc làm với anh Tư lệnh mình cũng có biểu cảm như vậy sao...?",
    "しれー……会いたいな……": "Anh Tư lệnh ơi... em nhớ anh quá...",
    "身体の芯に残る熱が、急激に寂しさへと形を変えていく。ユーリは確信する。<br>この胸の隙間を埋めることができるのは、世界でたった１人しかいない――": "Hơi ấm sâu trong cơ thể bỗng hóa thành nỗi cô đơn. Yuri tin chắc rằng,<br>người duy nhất trên thế giới có thể lấp đầy khoảng trống trong tim cô chỉ có một――"
}

# ==============================================================================
# HMR_10220100031 (Yuri 3 Intro - Soup)
# ==============================================================================
translations["hmr_10220100031"] = {
    ...
    "ああ、ユーリさん。司令官は今、大穴の報告書の処理に追われてまして。<br>ここ数日、ろくに眠れてないので……そろそろ限界ですね。": "A, cô Yuri. Tư lệnh đang bù đầu xử lý báo cáo về Hố Sâu.<br>Mấy ngày nay anh ấy chưa được chợp mắt... sắp kiệt sức rồi.",
    ...
    "宿舎に、ノルトメキア神殿から取り寄せた特別な材料があるんです。<br>それを使って、しれーに栄養満点のお食事を作ってあげたいと思いまして！": "Ở ký túc xá em có nguyên liệu đặc biệt từ thần điện Nortmekia.<br>Em muốn dùng nó nấu món canh bổ dưỡng cho anh Tư lệnh bồi bổ!",
    "それはいいですねっ！　きっと司令官も喜びます！<br>キッチンはお好きに使ってください♪": "Ý hay đấy! Chắc chắn Tư lệnh sẽ vui lắm!<br>Em cứ tự nhiên dùng bếp nhé♪",
    "しばらくして、司令本部内には食欲をそそる芳醇な香りが漂い始める。<br>目の前に出された熱々のスープを、吸い込まれるように口へと運ぶ。": "Một lúc sau, mùi thơm ngào ngạt kích thích vị giác lan tỏa khắp phòng.<br>Tôi như bị cuốn hút mà húp từng thìa canh nóng hổi được dọn ra.",
    "う、美味い！　あんまり見たことのない食材ばかりだが、<br>これは美味すぎるぞ……っ！": "N-Ngon quá! Toàn nguyên liệu lạ mắt chưa từng thấy bao giờ,<br>nhưng hương vị lại thơm ngon đến khó tin...!",
    "こちらは、わたしの住んでいたノルトメキアで採れる山菜や鶏肉、<br>それに香草をふんだんに使った滋養強壮スープです！": "Đây là món canh đại bổ nấu từ rau rừng, thịt gà Nortmekia<br>và rất nhiều loại thảo mộc đặc biệt của quê em đấy ạ!",
    "お仕事でお疲れの身体でもあっさり食べられて、栄養満点なんですよ。<br>すぐに元気になりますからね♪": "Món này thanh đạm dễ ăn ngay cả khi mệt mỏi lại cực kỳ bổ dưỡng.<br>Anh sẽ hồi phục sinh lực ngay thôi♪",
    "スープを口に運ぶ度、身体に異変が起き始める。それは単なる疲れが取れる<br>レベルではない。身体の芯から、熱い衝動がドクドクと突き上げてくるのだ。": "Mỗi thìa canh vào bụng, cơ thể tôi bỗng biến chuyển kỳ lạ.<br>Không chỉ tan biến mệt mỏi, mà sâu bên trong có một luồng nhiệt cuồn cuộn dâng trào.",
    ...
    "こ、これは、確かに元気になってきたが……なんだか、身体が熱くて、<br>その、ある部位が特に……": "Đ-Đúng là anh thấy khỏe khoắn hẳn... nhưng người cứ nóng ran,<br>đặc biệt là... chỗ đó...",
    ...
    "ユーリは恥ずかしさに耳まで赤くしながらも、<br>慈愛に満ちた瞳でこちらを見つめてくる。": "Yuri xấu hổ đỏ ửng cả vành tai,<br>nhưng vẫn nhìn tôi với ánh mắt đầy vẻ dịu dàng trìu mến.",
...
translations["hmr_10220100032"] = {
    "ベッドの上でユーリと向き合う。スープの熱が陽炎のように立ち上がり、<br>耐え難いほどの衝動が、こちらの理性を内側から削り取っていく。": "Đối diện Yuri trên giường, luồng nhiệt từ bát canh bốc lên như lửa đốt,<br>dục vọng mãnh liệt đang thiêu rụi lý trí tôi từ bên trong.",
    "さっきの食事なんなんだ？　身体が熱くて……歯止めが効かない……。<br>ユーリにそんな質問を投げかける。": "Món canh ban nãy là gì thế? Người anh nóng quá... không kìm lại được...<br>Tôi cất tiếng hỏi Yuri.",
    "アレは険しい山道を歩き続けるための滋養強壮スープですからね。<br>しれーの場合はその効果が下半身の方に集中しちゃったみたいですけど……": "Đó là canh bổ dưỡng để dẻo dai vượt đường núi mà.<br>Chỉ là với anh Tư lệnh thì tác dụng lại dồn hết xuống phần dưới...",
    ...
    "急に始まった抽送に、たまらずユーリは甲高い嬌声を上げる。<br>前回の遭難時よりも硬く膨れ上がった肉棒が、膣内を容赦なく蹂躙していく。": "Trước những cú nhấp dồn dập, Yuri cất tiếng rên kiều mị.<br>Thanh thịt cương to hơn cả lần trước không thương tiếc cày xới bên trong.",
    ...
    "その時、彼女の熱心すぎる反応と、<br>スープの過剰な効果にある１つの疑念を抱いてしまう。": "Lúc này, trước phản ứng cuồng nhiệt của cô và công hiệu quá đà của món canh,<br>tôi bỗng nảy sinh một mối nghi ngờ.",
    ...
    "不満げに、けれど切なそうに訴えてくるユーリ。<br>その瞳をじっと見つめて、浮かんだ疑問を問いかける。": "Yuri phụng phịu trách móc nhưng ánh mắt lại đầy vẻ khát khao.<br>Tôi nhìn thẳng vào mắt cô bé và hỏi câu hỏi trong lòng.",
    ...
    "お前は神に仕える身のはずなのにいいのか？　こんな罪なことして――<br>と、呆れたように告げる。": "Em là người phụng sự thần linh cơ mà? Làm chuyện tội lỗi thế này có sao không đấy――<br>tôi vờ thở dài trêu cô.",
    "いいえ、これは罪なことではありません！ <br>だ、だって……今わたしは、しれーに仕える身ですから！": "Không, đây đâu phải chuyện tội lỗi!<br>V-Vì... bây giờ em là người phụng sự anh Tư lệnh mà!",
    "彼女は真っ直ぐに、力強く宣言した。神への忠誠よりも、<br>今、目の前にいる自分への献身を選ぶと言うのだ。": "Cô bé dõng dạc tuyên bố. Rằng thay vì lòng trung thành với thần linh,<br>cô chọn dâng hiến trọn vẹn cho người đang ở trước mắt.",
    ...
    "いつにも増した甘いユーリの声に、昂ぶっていく。<br>もっともっと、この少女を乱れさせたくなる。": "Giọng rên nũng nịu hơn mọi khi của Yuri khiến tôi càng thêm hưng phấn.<br>Tôi muốn làm cho cô bé này đê mê hơn nữa.",
    ...
    "角度を変えて腰を突き入れるたび、ユーリはおもしろいくらい敏感に反応する。<br>艶めかしく身体をよがらせるユーリの姿に、こちらの息も荒くなる。": "Mỗi lần đổi góc thúc, Yuri đều phản ứng nhạy cảm một cách mê người.<br>Thấy cô bé uốn éo thân mình đầy dâm mỹ, hơi thở tôi cũng dồn dập theo.",
    "ユーリの膣はびくびくと痙攣するように蠕動し、こちらの肉棒を<br>きゅっと締め上げてくる。膣襞がカリ首をこそぎあげ、思わず声が漏れる。": "Âm đạo Yuri co thắt giật giật, siết chặt lấy thanh thịt của tôi.<br>Những nếp gấp niêm mạc miết chặt lấy rãnh quy đầu làm tôi phải bật ra tiếng rên.",
    "ああぁっ、気持ち、……いいっ！　し、しれー……！<br>も、もっともっと……激しくしてくださぁい……っ！": "Aaa, sướng... quá! A-Anh ơi...!\nX-Xin anh hãy làm mạnh hơn... mạnh hơn nữa đi ạ...!",
    "どこまでも貪欲にこちらを求めてくるユーリに、自制がきかなくなっていく。<br>寝不足のはずなのに体力は尽きることなく、突き出す腰にさらに力がこもる。": "Sự khao khát vô tận của Yuri khiến tôi mất hết kiềm chế.<br>Dù thiếu ngủ nhưng sinh lực vẫn dồi dào, tôi dồn thêm sức vào từng cú thúc.",
    ...
    "腰を大きく引き、そのぶん深く突く。<br>ストロークは長く、けれど抽送はさらに速く、ユーリの蜜壷を激しくかき回す。": "Tôi rút hông ra thật xa rồi thúc thật sâu vào trong.<br>Biên độ dài và nhịp thúc nhanh như muốn khuấy đảo hoa huyệt của Yuri.",
    ...
    "極限の快楽に、ユーリは髪を振り乱して翻弄されている。<br>小さな身体には激しすぎるかとも思ったが、こちらを求める声はやまない。": "Trong cơn cực khoái, Yuri lắc lư mái tóc đắm chìm vào nhục cảm.<br>Dù sợ cơ thể nhỏ nhắn quá tải, nhưng tiếng cô cầu xin vẫn không ngừng vang lên.",
    ...
    "ユーリは背中を仰け反るようにして絶頂に達する。と、ほぼ同時に<br>亀頭が爆発し、大量の白濁液がユーリの子宮目掛けて放出されていく。": "Yuri ưỡn cong lưng đón nhận cơn cực khoái. Gần như cùng lúc,<br>quy đầu bùng nổ, bắn ra lượng lớn tinh dịch trắng đục xối thẳng vào tử cung.",
    "はぁっ……はぁっ……んんっ……。ぁっ……はぁっ……。<br>しれーの精液……あったかくって……気持ち……いぃ……": "Hà... hà... ưm... a... hà...<br>Tinh dịch của anh... ấm áp quá... sướng... lắm...",
    "満足感に包まれ、しばし呆然としていたユーリ。<br>しかし、彼女の仕掛けた滋養強壮スープの効果は、まだ終わってはいなかった。": "Đắm chìm trong mãn nguyện, Yuri nằm ngẩn ngơ một lúc.<br>Thế nhưng công hiệu của món canh tráng dương cô nấu vẫn chưa chịu dừng lại.",
    "あ……しれーの、また大きくなってきましたね……": "A... của anh lại to lên nữa rồi kìa...",
    "射精直後にも関わらず、再び脈打ち始めた肉棒の脈動を感じ、<br>ユーリは愛おしそうに微笑む。": "Dù vừa mới xuất tinh, nhưng cảm nhận được thanh thịt đang đập rộn ràng,<br>Yuri mỉm cười đầy âu yếm.",
    ...
    "んっ……はぁぁっ……！　わたしは大丈夫ですよ……？<br>気が済むまで、何回でもおかわりしてくださっていいですから……": "Ưm... haaa...! Em không sao đâu ạ...<br>Bao nhiêu hiệp cũng được, anh cứ làm cho tới khi thỏa mãn nhé..."
}
...
translations["hmr_10220100033"] = {
    "窓の外から差し込む柔らかな朝の光が、寝室を白く染めていた。<br>昨夜の激しい情事の名残が嘘のように、穏やかで清々しい空気が流れている。": "Ánh bình minh dịu nhẹ rọi qua cửa sổ, nhuộm trắng phòng ngủ.<br>Bầu không khí trong lành như xua tan đi dấu vết cuồng nhiệt đêm qua.",
    ...
    "あぁ……。結局、昨夜は何回したのか途中から記憶がないが、<br>おかげでぐっすり寝られたよ。": "Ừ... Rốt cuộc tối qua làm bao nhiêu hiệp anh chẳng nhớ nổi nữa,<br>nhưng nhờ vậy mà ngủ một giấc thật say.",
    "身体を起こすと、不思議な感覚が<user>を包む。<br>連日の疲労が抜け、身体がスッキリと軽く、内側から活力が漲ってくるのだ。": "Khi ngồi dậy, một cảm giác kỳ diệu bao bọc lấy <user>.<br>Bao mệt mỏi tan biến, người nhẹ nhõm và sinh lực tràn trề từ bên trong.",
    "あの料理のおかげか……身体がメチャメチャ軽く感じる……。<br>す、すごい効果だな。": "Nhờ món canh đó sao... Người anh nhẹ bẫng đi này...<br>T-Tác dụng thần kỳ thật đấy.",
    "はい。山の神は、人に生きる力を与えてくれる神ですから！<br>よく食べ、生きる力を蓄えるのもその教えの１つなのです。": "Vâng ạ. Thần núi là vị thần ban sinh mệnh cho con người mà!<br>Ăn uống đủ chất để tích lũy sinh lực cũng là một trong những giáo lý đó.",
    "なるほど、生きる力ね……。<br>それにしても昨晩は、自分でも驚くほどの精力だった気がするよ。": "Ra là vậy, sinh lực sống à...<br>Cơ mà đêm qua sinh lực dồi dào đến mức chính anh cũng phải giật mình.",
    ...
    "一点の曇りもない、ひまわりのような明るい笑顔。<br>それが彼女にとって、神に仕えることと同義の、至極真っ当な愛の形なのだ。": "Nụ cười rạng rỡ như hoa hướng dương không gợn chút ưu phiền.<br>Với cô, đó là cách thể hiện tình yêu thiêng liêng như khi phụng sự thần linh.",
...
# ==============================================================================
# HMR_11030100011 (Naia 1 Intro - Locked room)
# ==============================================================================
translations["hmr_11030100011"] = {
    ...
    "ううんっ、大丈夫。お料理上手は片付け上手っ。<br>ひとり分のお皿くらい、へっちゃらだから♪": "Dạ thôi không cần đâu ạ. Nấu giỏi thì dọn dẹp cũng giỏi mà.<br>Chút bát đĩa của một người em lo loáng cái là xong♪",
    ...
    "えぇ～！？<br>もしかして、こんなところでも私の不幸体質が発動しちゃったのぉ！？": "Eh~!?<br>Không lẽ ngay cả ở đây mà vận xui của em cũng phát huy tác dụng sao!?",
    ...
    "そりゃまた災難だったな……。<br>だが、俺はナイアに無理をさせたくない、遠慮なくベッドを使ってくれ。": "Thế thì xui xẻo thật đấy...<br>Nhưng anh không muốn em phải chịu khổ, cứ tự nhiên nằm giường đi.",
...
translations["hmr_11030100012"] = {
    ...
    "頬を赤らめ、弱々しい声で訴えかけてくるナイア。<br>初めてなのか？　と、刺激を与えないように静かな声で尋ねてみた。": "Naia đỏ bừng má, khẽ thì thầm cầu xin.<br>Lần đầu của em à? Tôi hạ giọng dịu dàng hỏi để tránh làm em căng thẳng.",
    ...
    "すまん、と素直に謝る。初めてなのだから、優しくしないと――<br>軽口ではなく、快楽で緊張を解こうと心に決め、ナイアに触れていく。": "Anh xin lỗi, tôi chân thành nhận lỗi. Lần đầu thì phải thật nhẹ nhàng――<br>Tôi quyết định dùng khoái lạc xoa dịu nỗi sợ và chạm vào cơ thể Naia.",
    "んあぁ……はぁっ……はうっ……": "Ưm a... hà... hức...",
    "隆起した男性器の裏筋をクリトリスに擦り付け、快感を丁寧に送り込む。<br>愛撫を受けた彼女は小さく吐息して、いじらしく反応した。": "Tôi dùng phần gân dương vật cọ nhẹ lên hột le, tỉ mỉ truyền khoái cảm.<br>Được vuốt ve âu yếm, em khẽ thở dốc và phản ứng đầy đáng yêu.",
    ...
    "よく頑張ったなと声をかけた。<br>一方ナイアは繋がった部分を興味深そうに注視している。": "Em giỏi lắm, tôi dịu dàng khen ngợi.<br>Còn Naia thì tò mò chăm chú nhìn nơi hai cơ thể đang gắn kết.",
    "すごい……私のおまんこが、おちんちん食べちゃってるみたい……。<br>んっ……すごく硬いよ……勝手に締まっちゃう……": "Tuyệt quá... hoa huyệt của em như đang nuốt trọn lấy dương vật vậy...<br>Ưm... cứng quá... nó cứ tự động siết chặt lại...",
    "その言葉通り、膣内はギチギチに容赦なく肉棒を咀嚼してくる。<br>だが拒絶するのではなく、余すところなく快感を味わおうとする動きだった。": "Đúng như em nói, âm đạo siết chặt lấy thanh thịt không kẽ hở.<br>Nhưng đó không phải cự tuyệt, mà là muốn mút trọn từng chút khoái cảm.",
    "膣内はまさに蜜壺と言えるほどに濡れそぼっている。<br>じっとしているのが耐え難いほどに心地がよく、思わず陰茎に力がこもる。": "Bên trong ướt đẫm như một mật động ngọt ngào.<br>Cảm giác êm ái khiến tôi không thể đứng yên, bất giác gồng cứng dương vật.",
    ...
    "もちろんこちらも腰が震えるほどの快楽を覚えていた。<br>敏感な亀頭で蜜襞をゾリゾリと擦り上げる感触がたまらない。": "Bản thân tôi cũng run rẩy vì sướng ngất ngây.<br>Cảm giác quy đầu nhạy cảm miết qua từng nếp gấp âm đạo thật đê mê.",
    ...
    "そんなところが好きだ。不幸に負けずにがんばるところが<br>ナイアらしくて大好きだ――その言葉と共に、腰を強く打ち付けていく。": "Anh thích chính những điều đó ở em. Luôn kiên cường vượt qua xui xẻo<br>mới đúng là Naia anh yêu―― tôi vừa nói vừa thúc mạnh hông vào.",
    ...
    "蕩けるような声に、抑え切れない愛情と情欲が灯る。<br>そして彼女の眼差しからもより熱を感じるようになった。": "Trong giọng rên mê đắm ánh lên tình yêu và dục vọng không thể kìm nén.<br>Ánh mắt em nhìn tôi cũng ngày một nồng nàn rực cháy.",
    ...
    "好きという言葉が漏れた瞬間、狭かった膣内がいっそう強烈に締まった。<br>根本から先端まで隙間なく張り付いた膣壁が収縮――グイグイと絞られる。": "Khoảnh khắc lời yêu thốt ra, bên trong càng thắt chặt dữ dội hơn.<br>Thành âm đạo mút chặt từ gốc tới ngọn quy đầu―― bóp nghẹt lấy thanh thịt.",
    ...
    "最奥を突く瞬間、さっきよりも先端をねじ込むような意識で腰を進める。<br>子宮口を刺激されたナイアは未知の感覚に翻弄されていた。": "Tôi dồn sức thúc sâu quy đầu chạm thẳng vào miệng tử cung.<br>Bị kích thích tận nơi sâu kín nhất, Naia hoàn toàn đắm chìm trong khoái cảm lạ lẫm.",
    ...
    "今までで一番大きな喘ぎ声を聞きながら、膣内へ精液を吐き出す。<br>肉棒が律動するたびに甘い快楽が立ち昇り、全身に鳥肌が立った。": "Lắng nghe tiếng rên lớn nhất từ trước tới nay, tôi bắn xối xả tinh dịch vào trong.<br>Mỗi nhịp giật của thanh thịt mang lại khoái cảm ngọt ngào rợn cả tóc gáy.",
    ...
    "穏やかな笑みを向けられて、こちらの胸も幸福で満たされていた。<br>そうして幸せを分かち合いながら、しばらくの間、見つめ合うのだった――": "Nhìn nụ cười dịu dàng của em, lòng tôi cũng tràn ngập niềm hạnh phúc.<br>Cứ thế chia sẻ khoái cảm ngọt ngào, hai chúng tôi nhìn nhau đắm đuối――"
}
...
translations["hmr_11030100013"] = {
    ...
    "ぎゃんっ！？": "Oái!?",
    "どわーっ！？": "Ối trời ơi!?",
    "あたた、ごめんなさい……って、しし、司令官さん！<br>こんな、押し倒されてるところをフェルちゃんに見られたら……！": "Ui da, em xin lỗi... mà khoan, a-anh Tư lệnh ơi!<br>Cảnh anh đè lên người em thế này mà để Fortuna thấy thì...!",
...
# ==============================================================================
# HMR_11030100021 (Naia 2 Intro - Brothel Advice)
# ==============================================================================
translations["hmr_11030100021"] = {
    ...
    "い、いらっしゃいませー！<br>今夜は料理ではなくナイアシェフのことを召し上がってくださ～～い！": "K-Kính chào quý khách ạ!<br>Tối nay xin đừng nếm món ăn, mà hãy 'thưởng thức' bếp trưởng Naia điii~!",
    ...
    "全然。それより、接客についてのアドバイスなんだけど――<br>フェルトゥーナさんにいつも接するみたいにしてみたらどうかしら？": "Không hề. Mà này, chị có lời khuyên về cách tiếp khách này――<br>Em cứ đối xử với họ như cách em hay chăm sóc bé Fortuna xem sao?",
    ...
    "ふふっ。実は、お客様ってママさんプレイが好きな人が多いの。<br>その母性は絶対武器になるわ。": "Hi hi. Thật ra khách đến đây nhiều người thích trò đóng vai mẹ con lắm.<br>Bản năng làm mẹ ấy đảm bảo sẽ là vũ khí tối thượng của em.",
    "ちょうど、ナイアさんが今回お相手するお客様も<br>そういった趣向をお持ちなの――試してみてもらえる？": "Vừa hay vị khách lần này của Naia cũng có sở thích như thế đấy――<br>Em thử một phen xem sao nhé?",
    "う、うーん……わ、わかりました！<br>他にアイディアもないし、やってみます……！": "Ưm... v-vâng ạ!<br>Đằng nào cũng hết cách rồi, em sẽ cố thử xem sao...!",
    "――方針を決めたナイアは、<br>部屋で待つ客の元へ向かうのだった。": "――Sau khi xác định phương châm, Naia bước về phía căn phòng<br>nơi vị khách đang chờ đợi."
}

# ==============================================================================
# HMR_11030100022 (Naia 2 H-scene - Mommy play)
# ==============================================================================
translations["hmr_11030100022"] = {
    "寝そべる客に寄り添うようにして座ったナイア。<br>彼女の下着はすでに脱ぎ捨てられ、その美しい乳房を男の目に晒していた。": "Naia ngồi nép sát bên vị khách đang nằm dài trên giường.<br>Nội y đã cởi bỏ, để lộ cặp tuyết lê tuyệt mỹ trước mắt người đàn ông.",
    ...
    "……あの？": "...Anh ơi?",
    "戸惑っていると、ママ……と、期待の視線を向けながら呟かれた。<br>既に、客はプレイに入り切っているらしい。": "Đang bối rối thì gã nhìn em đầy mong đợi thốt lên 'Mẹ ơi...'.<br>Có vẻ như vị khách đã nhập tâm hoàn toàn vào vai diễn.",
    "（マ、ママかぁ……やっぱりこの歳でママはちょっとなぁ……）": "(M-Mẹ sao... tuổi này mà xưng mẹ thì có hơi ngại quá...)",
    "内心、複雑なナイア。だが、客はそれを敏感に感じ取ったのか<br>すぅ――っと冷めた表情になっていく。": "Trong lòng Naia rối bời. Nhưng vị khách dường như nhận ra sự ngập ngừng ấy<br>nên nét mặt gã bỗng lạnh dần đi.",
    ...
    "料理と同じだ。客の注文に応えるのは基本中の基本にして神髄。<br>挽回しなくてはならない。ルディアの言葉を思い返す。": "Cũng giống như nấu ăn, đáp ứng đúng yêu cầu của khách là trên hết.<br>Phải gỡ gạc lại thôi. Em nhớ lại lời dặn của Lydia.",
    ...
    "ナイアは必死に笑顔を取り繕い、その声色にも気を配った。<br>精一杯に優しい声を作って、男に語り掛ける。": "Naia cố nặn ra nụ cười và chỉnh lại ngữ điệu của mình.<br>Em dùng chất giọng dịu dàng nhất có thể để dỗ dành gã đàn ông.",
    "今日も頑張ってたね、よしよし♪<br>ママがたくさんご褒美あげるからね～。": "Hôm nay con cũng ngoan lắm, ngoan nào ngoan nào♪<br>Mẹ sẽ thưởng cho con thật nhiều nhé~.",
    "甘やかされた客は頬を緩め、本当の赤子のように喜ぶ。<br>実に満足そうだ。": "Được cưng nựng, vị khách giãn cơ mặt vui sướng như một đứa trẻ sơ sinh.<br>Trông gã vô cùng thỏa mãn.",
    ...
    "さらに満足してもらえるようにナイアは次の行動へ移る。<br>肉棒に絡めていた指へ、わずかに力をこめた。": "Để làm khách hài lòng hơn nữa, Naia chuyển sang bước tiếp theo.<br>Những ngón tay em khẽ siết nhẹ quanh thanh thịt.",
    ...
    "肉棒をそっとさするように愛撫する。<br>頭も一緒に優しく撫でると、男はくすぐったそうに目を細めた。": "Em nhẹ nhàng vuốt ve thanh thịt.<br>Vừa xoa đầu vừa vuốt ve, người đàn ông sướng râm ran híp cả mắt lại.",
    ...
    "ナイアは送り込まれる快楽に耐えつつ、奉仕を続けた。<br>男の荒い鼻息が乳房に当たり、くすぐったさを感じながらも手を動かす。": "Naia vừa chịu đựng khoái cảm vừa tiếp tục phục vụ.<br>Hơi thở phì phò của gã phả vào ngực làm em nhột nhưng tay vẫn đưa đẩy đều.",
    "んっ、ふぅ……はぁ……どぉ～？　ママのおっぱい、おいちい……？": "Ưm, phù... hà... thế nào~? Sữa mẹ có ngon không nè~?",
    "ふんふん、と切なく繰り返される鼻息で返事をされる。<br>健気な仕草が、じゅわっ、とナイアの胸に情欲を広げていく。": "Tiếng thở gấp gáp của gã như lời khẳng định.<br>Điệu bộ như con nít ấy khiến ngọn lửa dục vọng lan tỏa trong lòng Naia.",
    ...
    "甘く囁きながら、乳首を口に含ませた状態での手コキを繰り返す。<br>単純な往復運動だが、これが男を悦ばせていた。": "Vừa thì thầm ngọt ngào vừa cho gã ngậm ti sục cu liên hồi.<br>Những động tác lên xuống đơn giản ấy lại khiến gã sướng mê tơi.",
    "肉棒は限界まで膨張して、びくびくびく、と律動した。<br>先走りが幹の部分まで垂れて、ナイアの綺麗な指を汚している。": "Thanh thịt trướng to hết cỡ, giật thắt từng cơn liên tục.<br>Tinh dịch rỉ ra chảy dọc thân cặc làm ướt những ngón tay xinh của Naia.",
    ...
    "ダメでちゅよ～。ママには、思いっきり甘えないと……ママが、全部受け止めて<br>あげまちゅから♡　だから、たくさん幸せになってくだちゃい♡": "Không được nhịn đâu nha~. Với mẹ là phải nhõng nhẽo hết mình chứ... mẹ sẽ hứng trọn<br>cho con hết mà♡ Cứ sướng cho thỏa thích đi con yêu♡",
    ...
    "ナイアは手淫の周期を早める。快楽を強められた男はとても<br>感じているようで、さらに身を強張らせ、鼻息を荒くした。": "Naia tăng tốc độ quay tay. Khoái lạc dâng trào tột độ làm gã đàn ông<br>gồng cứng toàn thân, thở dồn dập như bò mộng.",
    "くっ……ふぅううんんっ……！": "Hức... phù ưm...!",
    "身を痙攣させる男は、助けを求めるように乳首を吸い立てた。<br>性感帯を鋭く刺激されたナイアも快感を覚えてしまう。": "Cơ thể co giật, gã như muốn tìm phao cứu sinh mà ra sức bú ngấu nghiến đầu ti.<br>Bị kích thích mạnh vào điểm nhạy cảm, Naia cũng rên lên vì sướng.",
    ...
    "ボクくんがどんなことをしても、ママはどこにもいかないから♡<br>安心して、気持ち良くなってくだちゃいね～……はぁ、ふぅ……": "Dù con có làm gì mẹ cũng không bỏ đi đâu mà♡<br>Cứ an tâm mà sướng đi nhé con yêu~... hà, phù...",
    ...
    "ナイアの心からの優しさに包まれ、男は限界に近づいていた。<br>先走りに白濁したものが混ざり始める。": "Được bao bọc bởi sự dịu dàng chân thành của Naia, gã đàn ông sắp bắn.<br>Những giọt dịch trắng đục bắt đầu rỉ ra ở đầu lỗ sáo.",
    ...
    "あっ……うぅんっ……♡　よちよち♡<br>だちて♡　だちて♡　白いおしっこ♡　しー、しー♡": "A... ưm...♡ Ngoan nào ngoan nào♡<br>Xả ra đi♡ xả ra đi con♡ nước tiểu màu trắng♡ tè đi nè, tè đi nè♡",
    "んっ、んっ、んっ……あっ、んんんんっ～～っ！": "Ưm, ưm, ưm... a, ưm ưm~~!",
    "猛り切った肉棒から精液が盛大に射出される。<br>独特の香りが室内に広まり、ナイアの鼻先にもまとわりついた。": "Từ thanh thịt cương cứng cực điểm, tinh dịch bắn tung tóe xối xả.<br>Mùi hương nồng nàn đặc trưng lan tỏa khắp phòng, quẩn quanh nơi cánh mũi Naia.",
    "甘イキしていたナイアは精液の香りを吸い込みながら余韻に浸る。<br>子宮の辺りから甘い痺れが広まり、割れ目からベッドに蜜を滴らせた。": "Naia vừa đạt cực khoái nhẹ cũng hít hà mùi tinh dịch đắm chìm trong dư vị.<br>Cơn tê dại lan khắp tử cung khiến dâm dịch từ hạ bộ nhỏ giọt xuống đệm.",
    "はぁ……はぁ……全部、出せまちたか？　ボクくん♡": "Hà... hà... con xả ra hết sạch chưa hả bé cưng♡",
    "息を早くしながらも、ナイアは男と視線を結び合わせていた。<br>その慈愛に満ちた微笑みに溶かされるように男の表情はだらしなくなっていく。": "Dù thở dốc nhưng Naia vẫn nhìn thẳng vào mắt gã.<br>Trước nụ cười nhân từ ấy, gương mặt người đàn ông giãn ra đầy thỏa mãn.",
    "そうでちゅか♡　たくさん、しーしーできてえらいでちゅね……♡<br>気持ち良くなれて、本当にえらい♡　よしよし……いい子ぉ、いい子ぉ～♡": "Vậy hả con♡ Tè ra được nhiều thế này giỏi quá đi...♡<br>Sướng được thế này là ngoan lắm♡ Ngoan nào ngoan nào... bé cưng ngoan quá~♡",
...
translations["hmr_11030100023"] = {
    ...
    "ナイアさんにママプレイをしてほしいって<br>お客様が殺到してるの！　よかったわねぇー♪": "Khách kéo đến nườm nượp đòi Naia phục vụ đóng vai mẹ con kìa!<br>Tuyệt quá còn gì nữa♪",
    ...
    "これで、あなたも立派な娼館の一員ね♪<br>悩みも解決したんじゃないかしら？": "Thế là em đã chính thức trở thành thành viên cốt cán của kỹ viện rồi nhé♪<br>Nỗi lo lắng cũng được giải quyết rồi còn gì?",
...
# ==============================================================================
# HMR_11030100031 (Naia 3 Intro - Kitchen Cooking)
# ==============================================================================
translations["hmr_11030100031"] = {
    ...
    "（もちろん味も良いし……ナイアがお嫁さんになったら<br>毎日おいしい料理が食べられて幸せだろうな……）": "(Đồ ăn lại ngon nữa... Nếu Naia mà làm vợ mình,<br>ngày nào cũng được ăn ngon thế này thì hạnh phúc biết mấy...)",
    "（……いかん。想像していると、なんだか抱きたくなってきた……。<br>ちょっとだけなら――触ってもいいか）": "(...Không xong rồi. Càng tưởng tượng lại càng muốn ôm em ấy...<br>Chỉ sờ một chút thôi chắc không sao đâu nhỉ)",
    "……きゃっ？": "...Á?",
...
# ==============================================================================
# HMR_11030100032 (Naia 3 H-scene - Kitchen Sex)
# ==============================================================================
translations["hmr_11030100032"] = {
    ...
    "張りがあるお尻は柔らかさを伴っていて、触るだけで幸せな気分になれた。<br>我慢ができず両手の指を沈み込ませると、心地の良い弾力が返ってきた。": "Bờ mông săn chắc mềm mại, chỉ chạm vào thôi đã thấy ngập tràn hạnh phúc.<br>Không nhịn được, tôi bóp mạnh hai tay làm thịt mông nảy lên đàn hồi.",
    "もぉ～～……司令官さんったらぁ……あんっ……": "Thật là~~... anh Tư lệnh hư quá đi... a...",
    "ナイアはどこか楽しそうに、余裕のある笑みを浮かべている。<br>こちらも尻を味わう手が止められない。": "Naia tỏ vẻ thích thú, nở nụ cười đầy vẻ nuông chiều.<br>Tay tôi cũng không thể dừng xoa nắn bờ mông em.",
    ...
    "恍惚とした表情で、うっとりと呟かれる。<br>心から幸せそうな声のせいでこちらの気分も高まり、男根の硬さが増していく。": "Em thốt lên với nét mặt ngây dại đê mê.<br>Giọng rên ngập tràn hạnh phúc ấy khiến dương vật tôi càng thêm cương cứng.",
    ...
    "――絶品だ。とても気持ちいい。<br>答えた瞬間、じゅんっ、と膣内がいっそう濡れるのがわかった。": "――Tuyệt phẩm. Sướng lắm em ơi.<br>Vừa dứt lời, tôi cảm nhận được dâm dịch bên trong em lại tuôn ra ào ạt.",
    "んぁぁあっ……どうしよ……<br>私も、もっとほしくなっちゃったよぉ……っ。": "Ưm a... làm sao bây giờ...<br>Em cũng muốn được anh làm nhiều hơn nữa rồi...!",
    "彼女にそんなつもりはなかったのだろうが、<br>こちらを誘惑してくるには十分なほど破壊力のあるおねだりだった。": "Dù em không cố ý nhưng lời nũng nịu ấy có sức sát thương cực lớn,<br>khiến tôi không tài nào cưỡng lại nổi.",
    "とろとろの腟内もまた、ねだるように肉棒に吸い付いてくる。<br>もう耐えることはできず、欲望をぶつけるようにナイアへと体重をかける。": "Âm đạo ướt đẫm mút chặt lấy thanh thịt như đang mời gọi.<br>Không thể nhịn thêm, tôi dồn trọng lượng ghì chặt lấy Naia mà thúc tới.",
    ...
    "料理人らしく、味わいの深さを説明してくれた。<br>ナイアに与えている快楽の深さが想像できるせいで、もっと乱れさせたくなる。": "Đúng là đầu bếp, em miêu tả khoái cảm sống động như thưởng thức món ăn.<br>Biết em sướng nhường nào, tôi càng muốn làm em phát điên hơn nữa.",
    ...
    "ね、あなた……？": "Nè... mình ơi...?",
    "艶やかな声色で問い掛けられた瞬間、肉棒と心臓がドクンと脈打つのを感じた。<br>もっとナイアを独占したい、味わい尽くしたいという欲が強くなる。": "Nghe giọng gọi ngọt ngào ấy, tim và dương vật tôi đập thình thịch.<br>Dục vọng muốn chiếm trọn và thưởng thức Naia bùng cháy dữ dội.",
    "お願い、あなた……もっとして……<br>私、頑張るから……♡": "Xin mình đấy... hãy làm em nhiều hơn nữa đi...<br>Em sẽ cố gắng chiều mình mà...♡",
    "声だけでなく、潤った膣壁でぎゅっと肉棒をくるんで誘われた。<br>拒む理由はない。膣奥に狙いを定めて、最奥を先端で強く押し込む。": "Không chỉ giọng nói, thành âm đạo ướt đẫm cũng siết chặt mời gọi.<br>Chẳng có lý do gì để chối từ, tôi thúc mạnh quy đầu chạm tận đáy sâu.",
    ...
    "胸に宿った愛おしさに反応して、亀頭が膨張するのを感じた。<br>コリッとした子宮口をしっかり刺激できるよう、ピストンに力を込める。": "Đáp lại tình yêu trào dâng trong tim, quy đầu tôi trướng to thêm.<br>Tôi ra sức nhấp hông để kích thích mạnh mẽ vào miệng tử cung của em.",
    "やぁんっ♡　激しぃ……♡<br>もぉ、激しいのダメって言ったのに……あなたったら♡　あああん♡": "A nhược♡ Mạnh bạo quá...♡<br>Đã bảo không được làm mạnh rồi mà... mình hư quá à♡ Aaa♡",
    "きっと、手が届くなら頭をよしよしと撫でられていたに違いない。<br>それほど、キッチンの中は甘い空気で満たされている。幸せな空間だ。": "Nếu tay với tới được chắc em sẽ xoa đầu tôi khen ngợi mất.<br>Căn bếp ngập tràn bầu không khí ngọt ngào, một không gian đong đầy hạnh phúc.",
    ...
    "その変化はこちらも肉棒で感じている。膣内はほどよい弾力を維持したまま<br>完全に勃起した男根を受け入れ、味わっていた。": "Tôi cũng cảm nhận rõ điều đó qua thanh thịt. Bên trong em vẫn giữ độ đàn hồi,<br>ôm trọn và thưởng thức dương vật cương cứng tối đa của tôi.",
    "今ならどれだけ激しくしても、ナイアは受け入れてくれるだろう。<br>結合部から愛液が弾けるほどの勢いで、膣内での往復運動に没頭する。": "Lúc này dù tôi có làm dữ dội cỡ nào Naia cũng sẽ đón nhận.<br>Tôi miệt mài dập hông liên hồi đến mức dâm dịch bắn tung tóe quanh điểm giao hợp.",
    ...
    "ナイアは全身を切なく痙攣させている。膣内も連動して細動していた。<br>絶頂が近い。それは、こちらもだった。下腹部では熱が煮えたぎっている。": "Toàn thân Naia run rẩy co giật. Bên trong em cũng co thắt kịch liệt.<br>Em sắp lên đỉnh rồi. Và tôi cũng vậy, luồng nhiệt hạ bộ đang sôi sục.",
    ...
    "ナイアは全身と膣内を律動させながら、精液を子宮口で受け止めてくれた。<br>びゅくっびゅくっと肉棒が跳ねるたび、快楽で頭がクラクラした。": "Naia co thắt toàn thân đón trọn dòng tinh dịch nơi miệng tử cung.<br>Mỗi nhịp giật bắn của thanh thịt làm đầu óc tôi quay cuồng trong sung sướng.",
    "は、ああ、はぁぁぁっ……♡<br>くぅん……ふあん……はぁ、はぁあ……♡": "Hà, a, haaa...♡<br>Ưm... phù... hà, haaa...♡",
    "呼吸を整えながら、ナイアは余韻に浸っている。お尻も細かく、<br>ゆらゆら揺れていた。その動きが、最後の一滴まで射精を促してくる。": "Vừa thở dốc Naia vừa đắm chìm trong dư vị cực khoái. Bờ mông em khẽ đung đưa,<br>khiến tôi tiếp tục bắn ra từng giọt tinh dịch cuối cùng.",
...
translations["hmr_11030100033"] = {
    "……よしっ、お料理完成～！　ナイアシェフの<br>『スーパーウルトラジャスティスデリシャスお肉盛り』だよ～！": "...Xong rồi, món ăn đã hoàn thành~! Là món<br>'Mâm thịt siêu cấp vô địch chính nghĩa thơm ngon' của bếp trưởng Naia đây~!",
    ...
    "（……だけど、そんなところも可愛くて好きだなぁ。えへへ）": "(...Nhưng mà cái tính ngây ngô ấy cũng dễ thương ghê, em thích lắm. Hi hi)",
    ...
    "よかった！<br>それじゃあご希望通り、毎日作ってあげるね♡": "Tuyệt quá!<br>Thế thì đúng như anh mong ước, ngày nào em cũng sẽ nấu cho anh ăn nhé♡",
    "ナイアは眩しい笑顔を<user>に向ける。<br>彼女に見つめられたまま、最高の料理を味わうのだった――": "Naia nở nụ cười rạng rỡ hướng về phía <user>.<br>Dưới ánh mắt âu yếm của em, tôi thưởng thức trọn vẹn món ăn tuyệt hảo――"
}

# ==============================================================================
# GHI FILE VÀ KIỂM TRA ĐỘ DÀI & THẺ <br>
# ==============================================================================
...
for folder, kv in translations.items():
    ...
    # Kiểm tra quy tắc <br> và độ dài
    clean_kv = {}
    for ja, vi in kv.items():
        total_keys += 1
        # 1. Clean leading / trailing <br>
        ...
        # 3. Check chiều dài từng dòng
        lines = re.split(r"<br\s*/?>", vi)
        for idx, line in enumerate(lines):
            # Bỏ qua các tag HTML khi tính chiều dài hiển thị nếu có
            display_text = re.sub(r"<[^>]+>", "", line)
            if len(display_text) > 75:  # cho phép dung sai nhỏ nếu có tên dài
                errors.append(f"[{folder}] Dòng {idx+1} dài quá ({len(display_text)} ký tự): {line}")
    ...
    with open(file_path, "w", encoding="utf-8") as f:
        ...
        f.write("\n")
    print(f"Đã ghi: {file_path} ({len(clean_kv)} câu)")

print("\n" + "="*50)
print(f"Tổng kết: Đã xử lý {total_files} file ({total_keys} câu)")
if errors:
    print(f"CẢNH BÁO ({len(errors)} lỗi):")
    for err in errors[:10]:
        print("  -", err)
else:
    print("HOÀN HẢO! Tất cả các câu đều đạt chuẩn Text Width (<= 70-75 ký tự), tối đa 1 thẻ <br>, không trailing/leading <br>.")
